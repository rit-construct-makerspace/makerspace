            ...
            <AppBar position="static">
                <Stack direction="row" width="auto" padding="20px" justifyContent="space-between" alignItems="center">
                    <Stack spacing={1}>
                        ...
                        <Typography variant="body1">This website uses cookies to provide better user experience and functionality. You can control and configure cookies in your web browser. <Link href="https://www.rit.edu/cookie-statement" underline="hover" color="inherit" >Cookie Statement.</Link></Typography>
                    </Stack>
