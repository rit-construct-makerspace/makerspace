    ...
    >
        <Grid container spacing={3} mt={2}>
          {getEquipmentsResult.data?.equipments?.filter((m: Equipment) =>
              ...
              <Grid key={e.id} item>
                <EquipmentCard id={e.id??0} name={e.name} to={url + e.id} sopUrl={e.sopUrl} trainingModules={e.trainingModules} numAvailable={e.numAvailable} numUnavailable={e.numInUse}
