...
export default function UnpagedEquipmentCard({ id, name, setID, imageUrl, sopUrl, trainingModules, numAvailable, numUnavailable, byReservationOnly }: EquipmentCardProps) {
  ...
  return (
    <Card sx={{ width: 250, height: 345, backgroundColor: (numNotPassed != 0 || !hasApprovedAccessCheck) ? ((localStorage.getItem("themeMode") == "dark") ? null : "grey.200") : ((localStorage.getItem("themeMode") == "dark") ? "grey.800" : null) }} onClick={() => setID(id)}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="150"
