        ...
        >
            ...
            >
                <Grid container spacing={3} mt={2}>
                    ...
                    .map((e: Equipment) => (
                        <Grid key={e.id} item>
                            <EditableEquipmentCard id={e.id} name={e.name} to={url + e.id} archived={false} imageUrl={(e.imageUrl == undefined || e.imageUrl == null ? process.env.PUBLIC_URL + "/shed_acronym_vert.jpg" : "" + process.env.CDN_URL + process.env.CDN_EQUIPMENT_DIR +  "/" + e.imageUrl)} />
                        </Grid>
                    ))}
                </Grid>
            </RequestWrapper>
